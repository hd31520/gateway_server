...
export function serializeVerification(verification) {
  ...
  return {
    ...
    payerNumber: verification.payer_number || '',
...
export function serializeMerchantVerification(item) {
  ...
  return {
    ...
    payment_ref: item.transaction_id || '',
    payerNumber: item.payer_number || '',
...
export function serializeBillingRequest(request) {
  ...
  return {
    ...
    payerNumber: request.payer_number || '',
    ...
    paymentStartedAt: request.paymentStartedAt || null,
